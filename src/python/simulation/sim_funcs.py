...
def gensamplesigmapaths_gpu(sample_errors, kappa, xi, zeta, sigma0):
...
def genrfsamplestdNTSprices_gpu(alpha, theta, beta, gamma, kappa, xi, zeta, sigma0, S0, *, y0 = 0.0, npath = 1_000, ntimestep = 250, dt = 1 / 252, r = 1 / 250, d = 0.0, index ):
    d = d * dt
    r = r * dt
    ...
    try:
        ...
        print(ntsparam)
    sigma = gensamplesigmapaths_gpu(errors, kappa, xi, zeta, sigma0)
